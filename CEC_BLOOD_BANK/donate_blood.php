...
<div><input type="text" name="mobileno" class="form-control" pattern="[0-9]{10}" required></div>
</div>
<div class="col-lg-4 mb-4">
...
<option value="Female">Other</option>
      ...
      <div><input type="date" id="start" name="date" class="form-control" max="2018-12-31" onclick="setMaxDate()"></div>
      </div></div>
...
<div class="col-lg-4 mb-4">
<label for="address" class="form-label font-italic mb-0"> Address <span style="color:red">*</span></label>
...
<!-- <script>
  ...
  alert("Data added Successfully.");
   window.open("donate_blood.php");
  }

     </script> -->
    <script>
        // Function to set the max attribute of the date input to current date
        function setMaxDate() {
    ...
    <script>
        ...
        function validateForm() {
            const emailInput = document.forms["donor"]["emailid"].value;
