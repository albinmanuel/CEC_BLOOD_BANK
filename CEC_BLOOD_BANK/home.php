  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <div class="row">
          <div class="col">
        <img src="image\cec_logo_300.png" alt="image\cec_logo_300.png" width="500" height="500" >
         </div>
          <div class="col">
        <img src="image\images.jpeg" alt="images.jpeg" width="500" height="500">
           </div>
        </div>
      </div>
      <div class="carousel-item">
        <img src="image\pic1-01-scaled.jpeg" alt="image\pic1-01-scaled.jpeg" width="100%" height="500">
      </div>
...
<br>
        <h1 style="text-align:center;font-size:45px;">Welcome to CEC BLOOD BANK</h1>
<br>
        <div class="row">
...
<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="image\blood-donation.jpg" alt="" >
            </div>
        </div>
        <!-- /.row -->
