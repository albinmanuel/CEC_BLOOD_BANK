  ...
  <div id="content-wrap" style="padding-bottom:50px;">
    ...
    <div class="row">
      <div class="col-lg-8 mb-4">
        ...
        <form name="sentMessage"  method="post" onsubmit="return validateForm()">
            ...
            <div class="control-group form-group">
                <div class="controls">
                    ...
                    <input type="tel" class="form-control" id="phone" name="contactno" pattern="[0-9]{10}" required >
                </div>
            </div>
            <div class="control-group form-group">
                <div class="controls">
...
<script>
        ...
        function validateForm() {
            const emailInput = document.forms["sentMessage"]["email"].value;
