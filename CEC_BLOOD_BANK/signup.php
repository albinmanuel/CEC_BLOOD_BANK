...
@keyframes btn-anim4 {
  ...
  <form class="" name = "donor" action="saveuser.php" method="post" onsubmit="return validateForm()">

  <?php if(isset($result))
    if(!$result)
    echo '<div class="alert alert-danger" style="font-weight:bold"> This username is already used! Try another</div>';
    unset($result); ?>
<div class="login-box">
  <h2>SIGNUP</h2>
  <div class="user-box">
      <input type="text" name="fullname" class="form-control" value="" required autocomplete="off">
      <label>Name</label>
    </div>
    <div class="user-box">
    ...
    <div class="mm">
      <input type="submit" name="login" value="SUBMIT" style="cursor:pointer">
      <span></span>
      <span></span>
      <span></span>
      <span></span>
...
<script>
        ...
        function validateForm() {
            const emailInput = document.forms["donor"]["email"].value;
